...
const Footer = () => {
  return (
    <footer>
      <Wrapper>
        <div className="px-5 py-24 flex md:items-start text-start lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="basis-1/2 space-y-6 md:mx-0 mx-auto text-start md:text-left">
            <Link
              href={"/"}
          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-start">
            <div className="basis-1/2 lg:w-1/4 md:w-1/2 px-4">
              <h2 className="tracking-widest mb-3 text-xl font-bold">
                Programs
              </h2>
            ...
            <div className="basis-1/2 lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font tracking-widest mb-3 text-xl font-bold">
                Pages
              </h2>
              <nav className="list-none mb-10 space-y-4">
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Quarter 1</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Quarter 2</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Quarter 3</a>
                </li>
              </nav>
            </div>
          </div>
